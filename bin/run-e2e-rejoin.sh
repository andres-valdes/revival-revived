...
echo "=== launching HOST ==="
env RR_E2E=1 RR_E2E_ROLE=host RR_E2E_SCENARIO=rejoin RR_E2E_PORT="$PORT" RR_E2E_WORLD=e2e_mp \
...
env RR_E2E=1 RR_E2E_ROLE=client RR_E2E_SCENARIO=rejoin RR_E2E_PORT="$PORT" RR_E2E_HOST=127.0.0.1 RR_E2E_WORLD=e2e_mp \
